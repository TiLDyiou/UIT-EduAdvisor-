...
TERM_COURSES = {
    1: [
        ("IT001", True), ("MA006", True), ("MA003", True),
        ("PH002", True), ("NT015", True), ("ENG01", True),
    ],
    2: [
        ("IT002", True), ("IT005", True), ("MA004", True),
        ("IT006", True), ("SS006", True), ("ENG02", True),
    ],
    3: [
        ("IT004", True), ("NT209", True), ("IT003", True),
        ("SS004", True), ("MA005", True), ("ENG03", True),
    ],
    4: [
        ("IT007", True), ("NT106", True), ("NT219", True),
        ("NT208", True), ("SS010", True), ("SS007", True),
    ],
    5: [
        ("SS008", True), ("SS009", True), ("NT132", True),
        ("NT140", True), ("NT521", True),
    ],
    6: [
        ("NT230", True), ("SS003", True), ("NT114", True),
    ],
    7: [
        ("NT215", True), ("NT505", False), ("NT506", False), ("NT508", False),
    ],
}
    ...
    try:
        ...
        async with maker() as session:
            ...
            res = await session.execute(
                select(Major).where(Major.code == "7480202").limit(1)
            )
            ...
            for term_num, courses in sorted(TERM_COURSES.items()):
                ...
                for code, is_required in courses:
                    res = await session.execute(
                        select(Course).where(Course.code == code).limit(1)
                    )
