...
function DefaultGraphic() {
 ...
 `,
      ...
      <div className="relative w-full max-w-xl aspect-square max-h-[35vh] flex items-center justify-center mb-8 perspective-1000">
        ...
        <div
          className="w-40 h-40 rounded-[2rem] bg-tokyo-storm/90 border border-tokyo-border/60 shadow-[0_20px_40px_-10px_rgba(0,0,0,0.8)] flex flex-col items-center justify-center relative z-20 backdrop-blur-xl"
        ...
        >
          ...
          <div className="w-20 h-1.5 bg-tokyo-panel rounded-full overflow-hidden shadow-inner">
        ...
        <div
          className="absolute top-[2%] left-[8%] w-44 h-42 rounded-[1.5rem] bg-tokyo-panel/90 border border-tokyo-border/50 shadow-xl flex flex-col p-4 z-30 backdrop-blur-2xl overflow-hidden"
          style={{
        ...
        >
          <div className="flex items-center gap-2.5 mb-3">
            ...
            <span className="text-xs text-tokyo-variable font-medium tracking-wide">
              Lịch học
            </span>
          </div>
        ...
        <div
          className="absolute bottom-[5%] right-[2%] w-44 h-36 rounded-[1.5rem] bg-tokyo-storm/95 border border-tokyo-border/50 shadow-[0_15px_30px_-8px_rgba(0,0,0,0.7)] flex flex-col justify-center p-5 z-30 backdrop-blur-2xl"
          style={{
        ...
        >
          <div className="flex items-center justify-between mb-4">
            <span className="text-[10px] font-bold tracking-widest text-tokyo-comment uppercase">
              GPA
            </span>
      ...
      <div className="space-y-3.5 max-w-lg z-20">
        <h2 className="text-3xl xl:text-4xl font-light text-tokyo-fg tracking-tight leading-tight">
          Cá nhân hoá <br />
        ...
        <p className="text-tokyo-comment text-sm xl:text-base leading-relaxed font-light">
...
export default function OnboardingPage() {
  ...
  // User must explicitly request captcha to avoid rate limits
  ...
  return (
    <div className="flex min-h-screen lg:h-screen lg:overflow-hidden w-full bg-tokyo-night text-tokyo-fg font-sans selection:bg-cyan-500/30">
      ...
      <div className="w-full lg:w-5/12 xl:w-[40%] lg:h-full flex flex-col justify-center px-8 sm:px-16 lg:px-12 xl:px-20 py-12 lg:py-0 border-r border-tokyo-border/60 bg-tokyo-night/80 backdrop-blur-3xl relative z-20 shadow-2xl lg:overflow-y-auto">
        <div className="w-full max-w-sm mx-auto space-y-10 py-12">
          <header className="space-y-4">
            ...
            <p className="text-sm text-tokyo-comment font-light leading-relaxed">
          ...
          <form onSubmit={onSubmit} className="space-y-6">
            <div className="space-y-4">
              <div className="space-y-1.5">
                <label className="text-xs font-medium text-tokyo-variable ml-1">
                  Mã số sinh viên
                </label>
                <div className="relative group">
                  <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none text-tokyo-comment group-focus-within:text-cyan-400 transition-colors">
                    <User className="h-4 w-4" />
                  </div>
                  <input
                    className="w-full rounded-xl border border-tokyo-border/80 bg-tokyo-storm pl-11 pr-4 py-3 text-sm outline-none ring-offset-slate-950 transition-all focus:border-cyan-500 focus:bg-tokyo-storm focus:ring-2 focus:ring-cyan-500/20"
                    value={studentCode}
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative group">
                  ...
                  <button
                    ...
                    className="absolute inset-y-0 right-0 pr-3.5 flex items-center text-tokyo-comment hover:text-cyan-400 transition-colors focus:outline-none"
                    disabled={busy || !!jobId}
                  >
                    {showPassword ? (
            ...
            <div className="space-y-3 rounded-2xl border border-tokyo-border/80 bg-tokyo-storm/30 p-5 shadow-inner">
              <div className="flex items-center justify-between mb-1">
                <span className="text-xs font-medium text-tokyo-variable">
                  Mã xác nhận DAA
                </span>
                <button
                  type="button"
            ...
            <div className="space-y-3.5 pt-2">
              <label className="flex items-start gap-3 group cursor-pointer">
                <div className="flex items-center h-5">
                  <input
                    type="checkbox"
                    className="w-4 h-4 rounded border-tokyo-border bg-tokyo-night text-cyan-500 focus:ring-cyan-500/20 focus:ring-offset-slate-950 cursor-pointer"
                    checked={privacy}
                    onChange={(e) => setPrivacy(e.target.checked)}
                    disabled={busy || !!jobId}
                  />
                </div>
                <div className="text-sm text-tokyo-comment font-light">
                  Tôi đồng ý với{" "}
                  <button
                    type="button"
      ...
      <div className="hidden lg:flex w-7/12 xl:w-[60%] lg:h-full relative flex-col overflow-hidden bg-tokyo-night">
        ...
        <div className="absolute inset-0 bg-tokyo-storm/50 backdrop-blur-[100px] pointer-events-none z-0" />
